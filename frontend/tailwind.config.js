  ...
  theme: {
    extend: {
      colors: {
        ...
        primary    : { DEFAULT:'#10B981', dark:'#059669', light:'#34D399', glow:'rgba(16,185,129,0.25)' },
        accent     : { DEFAULT:'#06B6D4', dark:'#0891B2', light:'#67E8F9', glow:'rgba(6,182,212,0.25)' },
        success    : { DEFAULT:'#22C55E', light:'#4ADE80', glow:'rgba(34,197,94,0.2)' },
      ...
      backgroundImage: {
        'grid-pattern': "url(\"data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 32 32' width='32' height='32' fill='none' stroke='rgba(16,185,129,0.04)'%3e%3cpath d='M0 .5H31.5V32'/%3e%3c/svg%3e\")",
        'gradient-primary': 'linear-gradient(135deg, #10B981, #06B6D4)',
        'gradient-dark'   : 'linear-gradient(135deg, #061410, #0E2519)',
        'gradient-glow'   : 'radial-gradient(ellipse at top, rgba(16,185,129,0.15) 0%, transparent 60%)',
      },
      boxShadow: {
        card       : '0 1px 3px rgba(0,0,0,0.6), 0 0 0 1px rgba(16,185,129,0.08)',
        'card-hover': '0 8px 30px rgba(0,0,0,0.5), 0 0 0 1px rgba(16,185,129,0.25)',
      ...
      keyframes: {
        ...
        logoShine : { '0%,100%':{ filter:'drop-shadow(0 0 0 rgba(52,211,153,0))' }, '50%':{ filter:'drop-shadow(0 0 14px rgba(52,211,153,0.55))' } },
      },
      backdropBlur: { xs: '2px' },
